...
System.register("services/items.service", ["@angular/core", "@angular/common/http"], function (exports_4, context_4) {
    "use strict";
    var core_2, http_2, ItemsService;
        ...
        execute: function () {
            ItemsService = /** @class */ (function () {
                ...
                ItemsService.prototype.getItem = function (id) {
                    return this.http.get(this.server_url + '/backend/items/read-detail.php');
                };
...
System.register("items/create-item/create-item.component", ["@angular/core"], function (exports_6, context_6) {
    "use strict";
    var core_3, CreateItemComponent;
