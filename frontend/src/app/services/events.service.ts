...
import { IEvent, ISession } from '../models/events.model'
...
export class EventsService {
  ...
  getEvents():Observable<IEvent[]> {
    return this.http.get<IEvent[]>(this.server_url + '/backend/events/read.php')
      .pipe(catchError(this.handleError<IEvent[]>('getEvents', [])))
  }

  getEvent(id:number):Observable<IEvent> {
    return this.http.get<IEvent>(this.server_url + '/backend/events/read.php' + id)
