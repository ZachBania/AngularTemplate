...
System.register("app/user/user.model", [], function (exports_6, context_6) {
    "use strict";
...
System.register("app/user/auth.service", ["@angular/core", "@angular/common/http", "rxjs/operators", "rxjs"], function (exports_7, context_7) {
    "use strict";
    var core_3, http_2, operators_2, rxjs_2, AuthService;
...
System.register("app/main-sidebar/main-sidebar.component", ["@angular/core"], function (exports_8, context_8) {
    "use strict";
    var core_4, MainSidebarComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_8("MainSidebarComponent", MainSidebarComponent);
        }
    };
});
System.register("app/functions/functions.component", ["@angular/core"], function (exports_9, context_9) {
    "use strict";
    var core_5, FunctionsComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_9("FunctionsComponent", FunctionsComponent);
        }
    };
});
System.register("app/events/events.component", ["@angular/core"], function (exports_10, context_10) {
    "use strict";
    var core_6, EventsComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_10("EventsComponent", EventsComponent);
        }
    };
});
System.register("app/events/event-details/event-details.component", ["@angular/core"], function (exports_11, context_11) {
    "use strict";
    var core_7, EventDetailsComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_11("EventDetailsComponent", EventDetailsComponent);
        }
    };
});
System.register("app/events/create-event.component", ["@angular/core"], function (exports_12, context_12) {
    "use strict";
    var core_8, CreateEventComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_12("CreateEventComponent", CreateEventComponent);
        }
    };
});
...
System.register("app/events/events-resolver.service", ["@angular/core"], function (exports_15, context_15) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_15("EventsResolver", EventsResolver);
        }
    };
});
System.register("app/events/event-resolver.service", ["@angular/core"], function (exports_16, context_16) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_16("EventResolver", EventResolver);
        }
    };
});
System.register("app/app-routing.module", ["app/main/main.component", "app/main-sidebar/main-sidebar.component", "app/functions/functions.component", "app/events/events.component", "app/events/event-details/event-details.component", "app/events/create-event.component", "app/user/profile.component", "app/user/login.component", "app/events/events-resolver.service", "app/events/event-resolver.service"], function (exports_17, context_17) {
    "use strict";
    var main_component_1, main_sidebar_component_1, functions_component_1, events_component_1, event_details_component_1, create_event_component_1, profile_component_1, login_component_1, events_resolver_service_1, event_resolver_service_1, routes, routingComponents;
    ...
    return {
        ...
        execute: function () {
            exports_17("routes", routes = [
                ...
                { path: 'user', loadChildren: function () { return context_17["import"]('src/app/user/user.module').then(function (m) { return m.UserModule; }); } },
                // Default routes
                { path: '', redirectTo: '/main', pathMatch: 'full' },
                { path: '**', redirectTo: '/main', pathMatch: 'full' },
            ]);
            exports_17("routingComponents", routingComponents = [
...
System.register("app/app.component", ["@angular/core"], function (exports_18, context_18) {
    "use strict";
    var core_13, AppComponent;
...
System.register("app/events/event.component", ["@angular/core"], function (exports_19, context_19) {
    "use strict";
    var core_14, EventComponent;
        ...
        execute: function () {
            EventComponent = /** @class */ (function () {
                function EventComponent() {
                    this.eventDetailClick = new core_14.EventEmitter();
                }
            ...
            exports_19("EventComponent", EventComponent);
        }
    };
});
System.register("app/events/event-details/sessions.component", ["@angular/core"], function (exports_20, context_20) {
    "use strict";
    var core_15, SessionsComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_20("SessionsComponent", SessionsComponent);
        }
    };
});
System.register("app/events/event-details/create-session.component", ["@angular/core", "@angular/forms", "app/events/shared/index"], function (exports_21, context_21) {
    "use strict";
    var core_16, forms_2, index_1, CreateSessionComponent;
        ...
        execute: function () {
            CreateSessionComponent = /** @class */ (function () {
                function CreateSessionComponent() {
                    this.saveNewSession = new core_16.EventEmitter();
                    this.cancelAddSession = new core_16.EventEmitter();
                }
            ...
            exports_21("CreateSessionComponent", CreateSessionComponent);
        }
    };
});
System.register("app/common/jQuery.service", ["@angular/core"], function (exports_22, context_22) {
    "use strict";
    var core_17, JQ_TOKEN;
    ...
    return {
        ...
        execute: function () {
            exports_22("JQ_TOKEN", JQ_TOKEN = new core_17.InjectionToken('jQuery'));
        }
    };
});
System.register("app/common/simple-modal.component", ["@angular/core", "app/common/jQuery.service"], function (exports_23, context_23) {
    "use strict";
    var core_18, jQuery_service_1, SimpleModalComponent;
    ...
    return {
        ...
        execute: function () {
            SimpleModalComponent = /** @class */ (function () {
                ...
                __decorate([
                    core_18.ViewChild('modalcontainer')
                ...
                SimpleModalComponent = __decorate([
                    ...
                    __param(0, core_18.Inject(jQuery_service_1.JQ_TOKEN))
                ], SimpleModalComponent);
                return SimpleModalComponent;
            }());
            exports_23("SimpleModalComponent", SimpleModalComponent);
        }
    };
});
System.register("app/common/filter.pipe", ["@angular/core"], function (exports_24, context_24) {
    "use strict";
    var core_19, FilterPipe;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_24("FilterPipe", FilterPipe);
        }
    };
});
System.register("app/common/modal-trigger.directive", ["@angular/core", "app/common/jQuery.service"], function (exports_25, context_25) {
    "use strict";
    var core_20, jQuery_service_2, ModalTriggerDirective;
    ...
    return {
        ...
        execute: function () {
            ModalTriggerDirective = /** @class */ (function () {
                ...
                __decorate([
                    core_20.Input('modal-trigger')
                ], ModalTriggerDirective.prototype, "modalId");
                ModalTriggerDirective = __decorate([
                    core_20.Directive({
                        selector: '[appModalTrigger]'
                    }),
                    __param(1, core_20.Inject(jQuery_service_2.JQ_TOKEN))
                ], ModalTriggerDirective);
                return ModalTriggerDirective;
            }());
            exports_25("ModalTriggerDirective", ModalTriggerDirective);
        }
    };
});
System.register("app/main-nav/main-nav.component", ["@angular/core"], function (exports_26, context_26) {
    "use strict";
    var core_21, MainNavComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_26("MainNavComponent", MainNavComponent);
        }
    };
});
System.register("app/app.module", ["@angular/platform-browser", "@angular/core", "@angular/forms", "@angular/common/http", "app/app-routing.module", "@angular/router", "app/app.component", "app/main/main.component", "app/main-sidebar/main-sidebar.component", "app/functions/functions.component", "app/events/events.component", "app/events/event.component", "app/events/event-details/event-details.component", "app/events/create-event.component", "app/events/event-details/sessions.component", "app/events/event-details/create-session.component", "app/common/simple-modal.component", "app/events/shared/events.service", "app/user/auth.service", "app/common/jQuery.service", "app/events/events-resolver.service", "app/events/event-resolver.service", "app/common/filter.pipe", "app/common/modal-trigger.directive", "app/main-nav/main-nav.component"], function (exports_27, context_27) {
    "use strict";
    var platform_browser_1, core_22, forms_3, http_3, app_routing_module_1, router_1, app_component_1, main_component_2, main_sidebar_component_2, functions_component_2, events_component_2, event_component_1, event_details_component_2, create_event_component_2, sessions_component_1, create_session_component_1, simple_modal_component_1, events_service_2, auth_service_1, jQuery_service_3, jQuery, events_resolver_service_2, event_resolver_service_2, filter_pipe_1, modal_trigger_directive_1, main_nav_component_1, AppModule;
