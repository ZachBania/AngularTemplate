...
System.register("create-event.component", ["@angular/core"], function (exports_3, context_3) {
    "use strict";
    var core_2, CreateEventComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_3("CreateEventComponent", CreateEventComponent);
        }
    };
});
System.register("create-event.component.spec", ["@angular/core/testing", "create-event.component"], function (exports_4, context_4) {
    "use strict";
    var testing_1, create_event_component_1;
    ...
    return {
        ...
        execute: function () {
            describe('CreateEventComponent', function () {
                var component;
                var fixture;
